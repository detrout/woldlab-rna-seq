...
def list_encode_10x_targets():
    default = [
        ...
        "umi_per_cell.png",
        "qc_metric_violin.{}_EM_filtered.png".format(get_gene_model(config)),
        "pct_count_mt.{}_EM_filtered.png".format(get_gene_model(config)),
        "n_genes_by_counts.{}_EM_filtered.png".format(get_gene_model(config)),
